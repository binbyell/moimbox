...
class MyJoinedMeeting extends StatefulWidget {

  final Stream<QuerySnapshot> stream;
  MyJoinedMeeting({Key? key, required this.stream}): super(key: key);

  @override
  _testStream createState() => _testStream();
}

class _testStream extends State<MyJoinedMeeting> {
